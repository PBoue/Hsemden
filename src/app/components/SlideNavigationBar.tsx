...
import { ChevronLeft, ChevronRight, Home, Maximize, Minimize, Menu, List, Settings } from 'lucide-react';
...
export function SlideNavigationBar({
  ...
  useEffect(() => {
    const currentRef = document.querySelector(`[data-slide-index="${currentSlide}"]`);
    if (currentRef) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
        {/* Left side - Home button and counter */}
        ...
        {/* Center - Slide progress bars with hover previews */}
                  ...
                  {hoveredSlide === index && (
                    ...
                    >
                      <div className="bg-popover border border-border rounded-lg shadow-lg overflow-hidden min-w-[240px]">
                        {/* Color bar */}
                        <div className={`h-1.5 ${slide.color}`} />
