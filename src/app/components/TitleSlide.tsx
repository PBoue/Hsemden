...
import backgroundImg from '@/assets/cdc1065f99d95f00f8129bda6499a0f166a8555f.png';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-foreground max-w-2xl leading-relaxed">
                            Explorative Ausgangslage, menschzentrierte
                            Entwicklung und stufenweise Feldvalidierung
                        </p>
                    </motion.div>
