...
export function InterdisciplinarySlide() {
    ...
    const circles = [
        {
            name: 'AG Forschung & Feldarbeit',
            subtitle: '(Research Circle)',
        ...
        {
            name: 'AG Technik & Implementierung',
            subtitle: '(Tech Circle)',
        ...
        {
            name: 'AG Transfer & Kommunikation',
            subtitle: '(Transfer Circle)',
    ...
    const holacracyPrinciples = [
        {
            principle: 'Verteilte Verantwortung',
            description:
                'Entscheidungen werden dort getroffen, wo die Fachkompetenz liegt – Subsidiaritätsprinzip',
        },
        {
            principle: 'Agile Anpassung',
            description:
                'Regelmäßige Retrospektiven ermöglichen kontinuierliche Verbesserung der Zusammenarbeit',
        },
        {
            principle: 'Flexible Rollen',
            description:
                'Teammitglieder können mehrere Rollen in verschiedenen Arbeitsgruppen einnehmen',
        },
        {
            principle: 'Transparente Steuerung',
            description:
                'Alle Arbeitsgruppen, Rollen und Zuständigkeiten sind dokumentiert und einsehbar',
        },
    ];
            ...
            <div className="max-w-7xl mx-auto space-y-12 relative">
                ...
                >
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl">
                        Agile Arbeitsgruppen mit selbstorganisierten
                    ...
                    <div className="bg-card border border-border rounded-lg p-8">
                            ...
                            <div className="bg-primary/10 border-2 border-primary rounded-lg p-6 text-center">
                                <div className="flex items-center justify-center gap-3 mb-3">
                                    ...
                                    <h3 className="text-xl font-bold text-foreground">
                                        Steering Board (Projektleitung)
                                    </h3>
                                </div>
                                <p className="text-sm text-muted-foreground max-w-3xl mx-auto mb-4">
                                    Interfakultärer Steuerungskreis mit
                                    regelmäßigen Steering-Meetings zur
                                    strategischen Ausrichtung, Budget-Allokation
                                    und Risikomanagement. Verteilt
                                    Verantwortlichkeiten an Arbeitsgruppen.
                                </p>
                                <div className="flex flex-wrap justify-center gap-2 text-xs">
                                    <span className="px-3 py-1 bg-primary/20 rounded-full text-foreground">
                                        Entscheidungskompetenz
                                    </span>
                                    <span className="px-3 py-1 bg-primary/20 rounded-full text-foreground">
                                        Verbindung zu Arbeitsgruppen
                                    </span>
                                    <span className="px-3 py-1 bg-primary/20 rounded-full text-foreground">
                                        Ethik-Board
                                    </span>
                        ...
                        <div className="text-center mb-6">
                            <h4 className="text-lg font-bold text-foreground mb-2">
                                Arbeitsgruppen (Cross-funktional besetzt)
                            </h4>
                            <p className="text-sm text-muted-foreground">
                                Fakultätsmitglieder arbeiten in mehreren
                                Arbeitsgruppen mit
                            </p>
                        </div>
                            ...
                            {disciplines.map((disc, idx) => (
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-2">
                                        <div
                                            className={`${disc.color} p-2 rounded`}
                                        >
                                            <disc.icon className="w-5 h-5 text-white" />
                                        </div>
                                        <div
                                            className={`font-bold ${disc.textColor}`}
                                        >
                                            {disc.abbr}
                                        </div>
                                    </div>
                        ...
                        <div className="flex items-center justify-center gap-2 py-4">
                            ...
                            <span className="text-xs text-muted-foreground px-4">
                                Flexible Rollenzuordnung zwischen Arbeitsgruppen
                            </span>
                            <div className="flex-1 h-px bg-border"></div>
                        </div>
                        ...
                        <div className="bg-muted/30 rounded-lg p-4 text-center">
                            <p className="text-sm text-foreground">
                                ...
                                Wöchentliche Check-ins pro Arbeitsgruppe •{' '}
                                <span className="font-semibold">
                                    Steering-Meetings:
                                </span>{' '}
                                Monatlich zur strategischen Abstimmung
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {disciplines.map((discipline, index) => (
                            <div
                                key={index}
                                className="h-full bg-card border border-border rounded-lg overflow-hidden"
                            >
                                <div
                                    className={`${discipline.color} p-6 text-white`}
                                >
                                    <discipline.icon
                                        className="h-10 w-10 mb-4"
                                        aria-hidden="true"
                                    />
                                    <div className="text-sm font-medium tracking-wide opacity-90 mb-2">
                                        {discipline.abbr}
                                    </div>
                                ...
                                <div className="p-6">
                                    ...
                                    >
                                        {discipline.items.map((item, idx) => (
                                            ...
                                            >
                                                <span className="text-foreground mt-1 font-bold">
                                                    •
                                                </span>
                                                <span>{item}</span>
                                            </li>
                ...
                >
                    <h2 className="text-2xl font-bold text-foreground">
                        3. Arbeitsgruppen mit Auftrag & Zuständigkeiten
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {circles.map((circle, idx) => (
                            <div
                                key={idx}
                                className={`bg-card border-2 ${circle.color} rounded-lg p-6`}
                            >
                                ...
                                <div
                                    className={`mt-4 pt-4 border-t ${circle.color}`}
                                >
                                    <p className="text-xs text-muted-foreground">
                                        <span className="font-semibold text-foreground">
                                            AG-Leitung:
                                        </span>{' '}
                                        Verbindet Arbeitsgruppe mit Steering
                                        Board
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="bg-muted/30 border border-border rounded-lg p-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                            Teammitglieder übernehmen{' '}
                            <strong className="text-foreground">Rollen</strong>{' '}
                            statt fester Positionen. Eine Person kann mehrere
                            Rollen in verschiedenen Arbeitsgruppen innehaben.
                            Rollen werden in Steering-Meetings angepasst, wenn
                            Anpassungsbedarf entsteht.
                        </p>
                        <div className="flex flex-wrap gap-2 text-xs">
                            <span className="px-3 py-1 bg-muted rounded-full text-foreground">
                                SAG-Mitglied → Rolle in AG Forschung & AG
                                Konzeption
                            </span>
                            <span className="px-3 py-1 bg-muted rounded-full text-foreground">
                                TECH-Mitglied → Rolle in AG Konzeption & AG
                                Technik
                            </span>
                            <span className="px-3 py-1 bg-muted rounded-full text-foreground">
                                WI-Mitglied → Rolle in AG Transfer & AG
                                Forschung
                            </span>
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>
                                        ...
                                        Bei qualitativer Auswertung (falls
                                        realisierbar)
                                    </span>
                                </li>
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>
                                        <strong className="text-foreground">
                                            Cross-Circle-Reviews:
                                        </strong>{' '}
                                        Peer-Review über Circle-Grenzen hinweg
                                    </span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-foreground mt-1">
                                    ...
                                    <span>
                                        ...
                                        Systematische Bearbeitung von Spannungen
                                ...
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>
                                        ...
                                        Qualitätskriterien an definierten
                                        Meilensteinen (Anchor Circle)
                                    </span>
                                </li>
                            </ul>
                        </div>
