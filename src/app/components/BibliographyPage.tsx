...
export function BibliographyPage() {
    const references = [
        {
            category: 'Gute wissenschaftliche Praxis & Forschungsethik',
            items: [
                {
                    authors: 'Deutsche Forschungsgemeinschaft (DFG)',
                    year: '2022',
                    title: 'Leitlinien zur Sicherung guter wissenschaftlicher Praxis – Kodex',
                    publisher: 'DFG',
                    location: 'Bonn',
                    note: 'https://doi.org/10.5281/zenodo.6472827',
                },
                {
                    authors: 'Hochschule Emden/Leer',
                    year: '2020',
                    title: 'Ordnung zur Sicherung guter wissenschaftlicher Praxis an der Hochschule Emden/Leer',
                    publisher: 'Hochschule Emden/Leer',
                    location: 'Emden',
                    note: 'Amtliche Mitteilung Nr. 12/2020',
                },
                {
                    authors:
                        'Hochschule Emden/Leer, Fachbereich Soziale Arbeit und Gesundheit',
                    year: '2023',
                    title: 'Hilfen zur Gestaltung wissenschaftlicher Qualifikationsarbeiten',
                    publisher: 'Hochschule Emden/Leer',
                    location: 'Emden',
                },
            ],
        ...
        {
            category: 'Amtliche Statistiken',
            items: [
                {
                    authors: 'Statistisches Bundesamt (Destatis)',
                    year: '2023',
                    title: 'Statistiken der Kinder- und Jugendhilfe – Gefährdungseinschätzungen nach § 8a Absatz 1 SGB VIII 2022',
                    publisher: 'Statistisches Bundesamt',
                    location: 'Wiesbaden',
                    note: 'Fachserie 13 Reihe 6.4',
                },
                {
                    authors: 'Statistisches Bundesamt (Destatis)',
                    year: '2023',
                    title: 'Statistiken der Kinder- und Jugendhilfe – Vorläufige Schutzmaßnahmen 2022',
                    publisher: 'Statistisches Bundesamt',
                    location: 'Wiesbaden',
                    note: 'Fachserie 13 Reihe 6.2',
                },
                {
                    authors: 'Landesamt für Statistik Niedersachsen (LSN)',
                    year: '2023',
                    title: 'Statistischer Bericht K I 7 – j/2022: Gefährdungseinschätzungen nach § 8a Absatz 1 SGB VIII in Niedersachsen 2022',
                    publisher: 'Landesamt für Statistik Niedersachsen',
                    location: 'Hannover',
                },
            ],
        },
            ...
            items: [
                {
                    ...
                    year: '2023',
                    title: 'JAdigital – Orientierungsrahmen für die Digitalisierung in der Kinder- und Jugendhilfe',
                    publisher: 'DIJuF',
                    location: 'Heidelberg',
                },
                {
                    authors:
                        'Kindler, H., Lillig, S., Blüml, H., Meysen, T., Werner, A.',
                    year: '2006',
                ...
                {
                    authors:
                        'Wolff, R., Flick, U., Ackermann, T., Biesel, K., Brandhorst, F., Heinitz, S., Patschke, M.',
                    year: '2013',
            ...
            items: [
                {
                    ...
                    note: 'Verordnung (EU) 2016/679, insbesondere Art. 89 (Garantien und Ausnahmen für Verarbeitung zu Archivzwecken, wissenschaftlichen oder historischen Forschungszwecken)',
                ...
                },
                {
                    ...
                    note: 'insbesondere § 8a Schutzauftrag bei Kindeswohlgefährdung',
                    publisher: 'Bundesgesetzblatt',
                },
                {
                    authors: 'Land Niedersachsen',
                    year: '2022',
                    title: 'Niedersächsisches Datenschutzgesetz (NDSG)',
                    note: 'insbesondere § 13 Verarbeitung personenbezogener Daten zu wissenschaftlichen oder historischen Forschungszwecken',
                    publisher: 'Niedersächsisches Gesetz- und Verordnungsblatt',
                },
                {
                    authors: 'Roßnagel, A.',
                    year: '2018',
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    publisher: 'SAGE Publications',
                    location: 'Thousand Oaks, CA',
                    note: 'insbesondere Purposive/Purposeful Sampling',
                },
            ],
        },
    ];
            ...
            <div className="max-w-5xl mx-auto space-y-12">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground">
                        Ausgewählte Referenzen für das
                        DigiChildProtect-Forschungsdesign
                    </p>
                    <div className="text-sm text-muted-foreground italic border-l-4 border-primary pl-4 py-2 bg-muted/30">
                        Zitierweise nach APA 7th Edition (American Psychological
                        Association)
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                        Diese Liste stellt eine Auswahl relevanter Literatur
                        dar. Während der Projektlaufzeit wird kontinuierlich
                        weitere wissenschaftliche Literatur durch systematische
                        Datenbankrecherchen (Web of Science, Scopus, PubMed,
                        EBSCO) erschlossen und in das Literaturverzeichnis
                        aufgenommen.
                    </p>
                </motion.div>
            </div>
